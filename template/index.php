...
<head>
    <meta charset="UTF-8">
    <title>小肥的音乐搜索引擎 - By Slash</title>
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">Just For Fun</h2>
                <p class="am-text-center">For Rossi Chan</p>
            </header>
            <hr>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="http://beian.miit.gov.cn/" target="_blank">粤ICP备19017141号</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
